...
for (const href of ['https://clienthub.getjobber.com/client_hubs/example', 'https://clienthub.getjobber.com.evil.test/', 'https://evil.test/?clienthub.getjobber.com', 'javascript:alert(1)', '/gallery']) {
