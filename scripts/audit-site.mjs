...
for (const pathname of urls) {
  ...
  if (jobberShellCount) {
    ...
    if (!html.includes(`<script src="${jobberEmbedScript}" clienthub_id="${jobberEmbedId}" form_url="${jobberFormUrl}"></script>`)) {
      findings.push(`${pathname}: Jobber script has the wrong account or form URL`)
    }
